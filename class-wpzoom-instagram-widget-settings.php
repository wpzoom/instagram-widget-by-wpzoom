			...
			<div class="wpz-insta-wrap wpz-insta_settings-connect">
				...
				<div class="account-options">
					...
					<div class="account-option account-option_business">
						<h4 class="account-option-title"><?php esc_html_e( 'Connect via Facebook Page', 'instagram-widget-by-wpzoom' ); ?></h4>
					...
					<div class="account-option account-option_token">
                        ...
                        <a href="https://www.wpzoom.com/graph-auth/" target="_blank"><?php _e( 'Access Token Generator - Facebook Graph API', 'instagram-widget-by-wpzoom' ); ?></a> 
						<?php echo esc_html( 'or', 'instagram-widget-by-wpzoom' ); ?>

						<a href="https://www.wpzoom.com/instagram-business-auth/" target="_blank"><?php _e( 'Access Token Generator - Business Instagram Login', 'instagram-widget-by-wpzoom' ); ?></a> 
                        <br/>
