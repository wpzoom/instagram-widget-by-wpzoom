...
/******/ 	"use strict";
/*!*****************************************!*\
  !*** ./src/scripts/frontend/preview.js ***!
  \*****************************************/
  ...
  function applyPreviewUpdate(data) {
    ...
    if (itemsListGap && itemsListGap.style) {
      if (!isNaN(spacing) && spacing >= 0) {
        var gapSuffix = {
          ...
          1: 'em',
          2: '%'
        }[parseInt(data['spacing-between-suffix'], 10)] || 'px';
    ...
    if (data['font-size']) {
      var fsSuffix = {
        ...
        1: 'em',
        2: 'pt'
      }[parseInt(data['font-size-suffix'], 10)] || 'px';
    ...
    if (data['spacing-around'] !== undefined && data['spacing-around'] !== '') {
      var aroundSuffix = {
        ...
        1: 'em',
        2: '%'
      }[parseInt(data['spacing-around-suffix'], 10)] || 'px';
    ...
    var radiusSuffix = {
      ...
      1: 'em',
      2: '%'
    }[parseInt(data['border-radius-suffix'], 10)] || 'px';
    innerWraps.forEach(function (wrap) {
