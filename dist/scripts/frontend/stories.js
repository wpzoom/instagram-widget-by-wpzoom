...
/******/ 	function __nested_webpack_require_66663__(moduleId) {
...
/******/ 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_66663__);
/******/ 	
...
/******/ 	var __nested_webpack_exports__ = __nested_webpack_require_66663__("./src/index.ts");
/******/ 	this.Zuck = __nested_webpack_exports__["default"];
/******/ 	
/******/ })()
;
...
/***/ "./node_modules/zuck.js/src/styles/index.css"
/*!***************************************************!*\
  !*** ./node_modules/zuck.js/src/styles/index.css ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/*!*****************************************!*\
  !*** ./src/scripts/frontend/stories.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var zuck_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! zuck.js */ "./node_modules/zuck.js/dist/zuck.js");
/* harmony import */ var zuck_js_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! zuck.js/css */ "./node_modules/zuck.js/src/styles/index.css");
/* harmony import */ var zuck_js_skins_snapgram__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! zuck.js/skins/snapgram */ "./node_modules/zuck.js/dist/skins/snapgram.css");
/**
...
(function ($) {
  ...
  function injectModalStyles() {
    var styleId = 'wpz-insta-stories-modal-fix';
  ...
  function showModalOverlay() {
    var overlay = document.getElementById('wpz-insta-stories-overlay');
    if (overlay) {
   ...
   */
  var muteIconSVG = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path d=\"M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z\"/></svg>";
  var unmuteIconSVG = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path d=\"M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z\"/></svg>";

  /**
   * Check if the current story item has a video
   */
  function currentItemHasVideo() {
    var $activeItem = $('#zuck-modal .story-viewer.viewing .slides .item.active');
  ...
  function updateMuteButtonIcon() {
    var $muteBtn = $('#zuck-modal .wpz-insta-mute-btn');
    if ($muteBtn.length) {
  ...
  function injectMuteButton() {
    ...
    var $headerRight = $modal.find('.story-viewer .head .right');
    if ($headerRight.length) {
      var $closeBtn = $headerRight.find('.close');
      var $muteBtn = $('<button>').addClass('wpz-insta-mute-btn').attr('type', 'button').attr('aria-label', isGloballyMuted ? 'Unmute' : 'Mute').html(isGloballyMuted ? muteIconSVG : unmuteIconSVG).on('click', toggleMute);
      if ($closeBtn.length) {
  ...
  var initializedContainers = new Set();
  ...
  function enforceVideoMuteState(video) {
    ...
    var originalMutedDescriptor = Object.getOwnPropertyDescriptor(HTMLMediaElement.prototype, 'muted');
    ...
    var originalVolumeDescriptor = Object.getOwnPropertyDescriptor(HTMLMediaElement.prototype, 'volume');
  ...
  function initInstagramStories() {
    ...
    $('.wpz-insta-stories').each(function () {
      var _wpzInstaStories, _wpzInstaStories2, _wpzInstaStories3, _wpzInstaStories4, _wpzInstaStories5, _wpzInstaStories6, _wpzInstaStories7, _wpzInstaStories8, _wpzInstaStories9, _wpzInstaStories0, _wpzInstaStories1, _wpzInstaStories10, _wpzInstaStories11;
      var $container = $(this);
      ...
      var storiesDataAttr = $container.attr('data-stories');
      if (!storiesDataAttr) {
        return;
      }
      var storiesData;
      ...
      var timeline = [{
        ...
        seen: false,
        items: storiesData.items.map(function (item, index) {
          return {
            ...
            length: item.length || (item.type === 'video' ? 0 : 5),
            // 0 = use video duration
            link: item.link || '',
      ...
      var storiesContainerId = 'wpz-insta-zuck-' + instanceId;

      // Create new container for this feed instance
      var $storiesContainer = $('<div>').attr('id', storiesContainerId).addClass('wpz-insta-zuck-container').css({
        position: 'absolute',
        left: '-9999px',
        top: '-9999px',
        width: '1px',
      ...
      // Initialize Zuck.js
      var zuckInstance = new zuck_js__WEBPACK_IMPORTED_MODULE_0__.Zuck($storiesContainer.get(0), {
        skin: 'snapgram',
        avatars: true,
        list: false,
        cubeEffect: true,
        ...
        backButton: true,
        backNative: false,
        // Disable to prevent URL hash issues
        previousTap: true,
        localStorage: false,
        stories: timeline,
        language: {
          unmute: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories = wpzInstaStories) === null || _wpzInstaStories === void 0 || (_wpzInstaStories = _wpzInstaStories.i18n) === null || _wpzInstaStories === void 0 ? void 0 : _wpzInstaStories.unmute) || 'Touch to unmute',
          keyboardTip: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories2 = wpzInstaStories) === null || _wpzInstaStories2 === void 0 || (_wpzInstaStories2 = _wpzInstaStories2.i18n) === null || _wpzInstaStories2 === void 0 ? void 0 : _wpzInstaStories2.keyboardTip) || 'Press space to see next',
          visitLink: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories3 = wpzInstaStories) === null || _wpzInstaStories3 === void 0 || (_wpzInstaStories3 = _wpzInstaStories3.i18n) === null || _wpzInstaStories3 === void 0 ? void 0 : _wpzInstaStories3.visitLink) || 'Visit link',
          time: {
            ago: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories4 = wpzInstaStories) === null || _wpzInstaStories4 === void 0 || (_wpzInstaStories4 = _wpzInstaStories4.i18n) === null || _wpzInstaStories4 === void 0 ? void 0 : _wpzInstaStories4.ago) || 'ago',
            hour: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories5 = wpzInstaStories) === null || _wpzInstaStories5 === void 0 || (_wpzInstaStories5 = _wpzInstaStories5.i18n) === null || _wpzInstaStories5 === void 0 ? void 0 : _wpzInstaStories5.hour) || 'hour',
            hours: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories6 = wpzInstaStories) === null || _wpzInstaStories6 === void 0 || (_wpzInstaStories6 = _wpzInstaStories6.i18n) === null || _wpzInstaStories6 === void 0 ? void 0 : _wpzInstaStories6.hours) || 'hours',
            minute: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories7 = wpzInstaStories) === null || _wpzInstaStories7 === void 0 || (_wpzInstaStories7 = _wpzInstaStories7.i18n) === null || _wpzInstaStories7 === void 0 ? void 0 : _wpzInstaStories7.minute) || 'minute',
            minutes: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories8 = wpzInstaStories) === null || _wpzInstaStories8 === void 0 || (_wpzInstaStories8 = _wpzInstaStories8.i18n) === null || _wpzInstaStories8 === void 0 ? void 0 : _wpzInstaStories8.minutes) || 'minutes',
            fromnow: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories9 = wpzInstaStories) === null || _wpzInstaStories9 === void 0 || (_wpzInstaStories9 = _wpzInstaStories9.i18n) === null || _wpzInstaStories9 === void 0 ? void 0 : _wpzInstaStories9.fromnow) || 'from now',
            seconds: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories0 = wpzInstaStories) === null || _wpzInstaStories0 === void 0 || (_wpzInstaStories0 = _wpzInstaStories0.i18n) === null || _wpzInstaStories0 === void 0 ? void 0 : _wpzInstaStories0.seconds) || 'seconds',
            yesterday: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories1 = wpzInstaStories) === null || _wpzInstaStories1 === void 0 || (_wpzInstaStories1 = _wpzInstaStories1.i18n) === null || _wpzInstaStories1 === void 0 ? void 0 : _wpzInstaStories1.yesterday) || 'yesterday',
            tomorrow: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories10 = wpzInstaStories) === null || _wpzInstaStories10 === void 0 || (_wpzInstaStories10 = _wpzInstaStories10.i18n) === null || _wpzInstaStories10 === void 0 ? void 0 : _wpzInstaStories10.tomorrow) || 'tomorrow',
            days: typeof wpzInstaStories !== 'undefined' && ((_wpzInstaStories11 = wpzInstaStories) === null || _wpzInstaStories11 === void 0 || (_wpzInstaStories11 = _wpzInstaStories11.i18n) === null || _wpzInstaStories11 === void 0 ? void 0 : _wpzInstaStories11.days) || 'days'
          }
        },
        callbacks: {
          onOpen: function onOpen(storyId, callback) {
            ...
            if (activeZuckInstance && activeZuckInstance !== zuckInstance) {
              ...
              var $modalContent = $('#zuck-modal-content');
            ...
            var storyIndex = zuckInstance.findStoryIndex(storyId);
      ...
      $container.on('click.wpzInstaStories', function (e) {
        ...
        var $zuckContainer = $('#' + storiesContainerId);
        var $storyLink = $zuckContainer.find('.story > a');
        if ($storyLink.length) {
