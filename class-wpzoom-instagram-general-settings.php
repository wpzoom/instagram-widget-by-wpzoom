...
class WPZOOM_Instagram_General_Settings {
	...
	public function option_panel_init() {
		...
		add_settings_field(
			...
			esc_html__( 'Clear Data?', 'instagram-widget-by-wpzoom'),
	...
	public function settings_field_clear_data() {
		?>
		<a href="#" id="wpzoom_instagra_clear_data" class="button button-primary button-negative"><?php esc_html_e( 'Clear', 'instagram-widget-by-wpzoom' ); ?> <span class="wpzoom-loading"></span></a>
		<p class="description">
			<?php _e( 'Will remove all the data generated by the plugin', 'instagram-widget-by-wpzoom' ); ?>
		</p>
		<br/>
        <hr/>
		<?php
